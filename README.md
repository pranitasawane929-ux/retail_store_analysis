<img width="131" height="26" alt="image" src="https://github.com/user-attachments/assets/323a3f3c-b652-4d29-8f89-125c72cf198e" /># retail_store_analysis
...
Q 131 : Display city-wise revenue for UPI transactions. 
select city ,sum(price*quantity) as total_revenue from sales where payment_mode ='upi' group by city;
<img width="125" height="69" alt="image" src="https://github.com/user-attachments/assets/6b36a935-221d-4600-b822-bd798aeb695a" />

Q 132 : Display city-wise revenue for Electronics products.
select city , sum(price*quantity)as total_revenue from sales where category ='electronics ' group by city;
0 rows affected 

 Q 133 : Display city-wise revenue generated by female customers.
select city,sum(price*quantity) as total_revenue from sales where gender='female' group by city;
<img width="122" height="68" alt="image" src="https://github.com/user-attachments/assets/27e6d3c2-a1bf-449b-8e6d-b8278e756e4a" />

Q134 :  Display city-wise revenue for orders above 5,000.
select city ,sum(price*quantity) as total_revenue from sales where (price*quantity) > 5000 group by city ;
<img width="127" height="71" alt="image" src="https://github.com/user-attachments/assets/5acb31aa-76d2-4f53-b956-817cc0ec6dc1" />


Q 135 :  Display cities where revenue from orders above 5,000 exceeds 50,000 
select city , sum(price*quantity) as total_revenue from sales where (price *quantity)>5000 group by city having sum(price*quantity)>50000 ;
<img width="121" height="43" alt="image" src="https://github.com/user-attachments/assets/f5474e74-71db-4857-bb53-c43a1b324434" />

Q 136 :Display categories with more than 2 UPI orders. 
select category,count(*) from sales where payment_mode ='upi' group by category having count(*)>2;
<img width="110" height="47" alt="image" src="https://github.com/user-attachments/assets/40c8c50b-d0c3-4616-820c-811ab375dbf0" />


Q 137 :  Display categories where Card payment revenue exceeds 10,000.
 select category, sum(price*quantity) as total_revenue from sales where payment_mode  ='card' group by category having sum(price*quantity) >10000 ;
 0 row affected 

  Q 138 : Display category-wise count of products having rating above 4.5.
 select category ,count(*) from sales where rating >4.5 group by category ;
 <img width="110" height="56" alt="Screenshot 2026-06-25 124738" src="https://github.com/user-attachments/assets/a4dd51d6-1c2b-4bf0-8cc6-fb081df4917c" />



Q 139 :  Display city-wise revenue generated by customers older than 25.
 select city, sum(price*quantity) as total_revenue from sales where age > 25 group by city ;
 <img width="122" height="55" alt="image" src="https://github.com/user-attachments/assets/b21f4835-9856-4a1e-b00b-bd4e77e6e39d" />

 140 :  Display cities where revenue generated by customers older than 25 exceeds 20,000
 select city , sum(price *quantity) as total_revenue from sales where age > 25 group by city having sum(price *quantity) >20000 ;
 <img width="121" height="42" alt="image" src="https://github.com/user-attachments/assets/4384d480-2046-4fe1-9a21-c9e3591082a8" />

Q 141 :  Identify the city generating the highest revenue. 
